...
def save_conversation_summary(conversation_id: str, summary: dict,
                               participants: list, session_id: str = ""):
    ...
    with _lock:
        ...
        print(f"[Store] 💾 Saved summary for conv_id={conversation_id[:8]}... "
